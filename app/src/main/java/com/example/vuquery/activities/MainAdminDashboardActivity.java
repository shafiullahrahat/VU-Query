...
import com.example.vuquery.fragments.Admin_CSE_first_semester_course_list_Fragment;
...
public class MainAdminDashboardActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{

    private FirebaseAuth firebaseAuth;
    ImageButton logOutBtn;
    TextView emailTv, IDTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addCourseButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), MainAdminAddCoursesActivity.class));
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    ...
                    case R.id.privacyPolicyMenu:
                        ...
                        intent3.putExtra("menuItemNo", "adminPrivacy");
    ...
    private void showCourseNames(int i) {
        if (i==0){
            Fragment fragment = new Admin_CSE_first_semester_course_list_Fragment();
